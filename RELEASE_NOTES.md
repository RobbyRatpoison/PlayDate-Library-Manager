...
- Added Add Game to the menu: add any game by hand from a Steam search, or as a custom entry, even if you don't own or have installed it. (prompted by Mayanaise)

### Fixes

- Fixed game names sorting capitalised titles ahead of all lowercase ones instead of alphabetically. (reported by Mayanaise)
