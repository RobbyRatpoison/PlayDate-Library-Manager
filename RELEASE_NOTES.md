...
- Card badges have a new size slider (Appearance > Card Badges).
- Card platform badges now ship with built-in icons for Steam and every official plugin.
- The Plugins window shows each platform's logo.
